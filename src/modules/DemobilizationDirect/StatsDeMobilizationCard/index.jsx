...
const StatsDirCard = ({ TotalPersonDemobilization }) => {
      ...
      <StyledFlexWrapper>
        <StyledFlexContainer>
          <StyledIconWrapper
            style={{
              color: "#0A8FDC",
              backgroundColor: TotalPersonDemobilization?.color + '22',
            }}
          >
{/*             
          ...
          <div style={{ marginRight: 8, overflow: 'hidden' }}>
            <Typography.Title level={5}>Number Of Demobilization</Typography.Title>
            <StyledTitleWrapper>
              
            <CountUp end= {TotalPersonDemobilization}></CountUp>
              </StyledTitleWrapper>
          </div>
        </StyledFlexContainer>
        <StyledToggleContainer>
