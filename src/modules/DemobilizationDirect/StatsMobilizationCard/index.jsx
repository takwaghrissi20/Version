...
const StatsDirCard = ({TotalPersonMobilization }) => {
      ...
      <StyledFlexWrapper>
        <StyledFlexContainer>
          <StyledIconWrapper
            style={{
              color: "#0A8FDC",
              backgroundColor: TotalPersonMobilization?.color + '22',
            }}
          >
{/*             
          ...
          <div style={{ marginRight: 8, overflow: 'hidden' }}>
            ...
            Number Of Mobilization</Typography.Title>
            <StyledTitleWrapper>
            <CountUp end= {TotalPersonMobilization}></CountUp>
