...
const Integration = () => {
  ...
  const fetchDataIntegration = async () => {
    try {
      ...
      const last14DaysIntegration = data.filter(integration => new Date(integration.integrationDate) > last14Days);
  ...
  console.log("countIntegrationByDay", Object.values(integrationCountByDay))
