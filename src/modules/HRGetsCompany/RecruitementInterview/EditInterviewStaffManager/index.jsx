    ...
    try {
      const response = await fetch(`https://dev-gateway.gets-company.com/api/v1/int/updateintv?id=${interviewCode}&token=${token}`, {
        ...
        body: JSON.stringify({
          ...
          propsedsalaryBod1: proposedSalary1,
          propsedsalaryBod2: idStaff?.propsedsalaryBod2,
          dailyRateBod1: proposedDaily1,
                  ...
                  <AppRowContainer style={{ marginTop: 32, marginBottom: 32 }}>
                    ...
                    {(name?.toLowerCase().includes("ali")) && (
                      <Col xs={24} md={18}>
                        <StyledShadowWrapper>
                          <AppRowContainer>
                            {idStaff?.directSign2?.length === 0 || idStaff?.directSign2 == null && (
                              <p></p>
                            )
                      ...
                      <Col xs={24} md={18}>
                        <StyledShadowWrapper>
                          <AppRowContainer>
                            ...
                            {!idStaff.directSign1 === "" || !idStaff?.directSign1 == null
