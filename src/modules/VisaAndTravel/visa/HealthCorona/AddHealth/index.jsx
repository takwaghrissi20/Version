...
const AddHeath = () => {
  ...
  //   try {
  //     const response = await fetch(`https://dev-gateway.gets-company.com/api/v1/vacin/add?id=${idProject}`, {
            ...
            <StyledShadowWrapper>
              <AppRowContainer>
                ...
                {selectedVaccin === 'Fetness Certificate' && (
                  <>
             <Col xs={24} md={12}>
                  <Form.Item label='Date Of Health Test' name='Date :'
                  >
                    <DatePicker
                      style={{ width: "100%", height: "30px" }}
             ...
             <Col xs={24} md={12}>
                ...
                <Col xs={24} md={12}>
                    <Form.Item label='Date Of Covid Vaccin Second Dose Date ' name='Date :'
                  >
                    <DatePicker
                      style={{ width: "100%", height: "30px" }}
                      placeholder="YYYY-MM-DD"
