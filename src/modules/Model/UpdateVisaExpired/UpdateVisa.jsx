...
const UpdateVisa = (props) => {
  ...
  const [newVisaDate, setNewVisaDate] = useState(dayjs(dateemp?.finishDateVisa));
  ////////////////////Update Date Visa Expired
  const openNotificationError = () => {
    notification.open({
      message: 'Error',
      description: 'Error Update Date Visa Finish',
      style: {
        backgroundColor: 'red',
  ...
  const openNotification = () => {
    notification.open({
      message: 'Success',
      description: 'Success Update Date Visa Finish :',
      style: {
    ...
    <StyledContactForm>
        ...
        <Form.Item >
          ...
          <label htmlFor='icon-button-file'>
            < StyledContactFormHeaderTitle  >
              ...
              <p className='TitleModal'>Update Visa Will Be Expired After 15 Days</p>
      ...
      <StyledContactModalScrollbar>
        <StyledContactFormContent>
          <StyledContactFormContentItem>
            <StyledContactFormItemTitle>
              <p className='SousTitle'> Visa Date Information</p>
            ...
            <StyledContactFormContentField>
              ...
              <Form.Item className='form-field'>
                <FloatLabel name="Interview Date">
                  <span className='modallabel'> Date Visa Finish :</span>
                  <DatePicker
                    className='Input'
                    style={{ height: "2rem", marginTop: "0.75rem" }}
                    placeholder={dateemp?.finishDateVisa}
                    onChange={(value) => setNewVisaDate(dayjs(value))}
                    value={newVisaDate}
