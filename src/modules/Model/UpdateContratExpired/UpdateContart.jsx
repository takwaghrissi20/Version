...
const UpdateContrat = (props) => {
  ...
  const [newContratDate, setNewContartDate] = useState(dayjs(dateemp?.finishDate));
  ////////////////////Update Date Visa Expired
  const openNotificationError = () => {
    notification.open({
      message: 'Error',
      description: 'Error Update Date Contrat Finish',
      style: {
        backgroundColor: 'red',
  ...
  const openNotification = () => {
    notification.open({
      message: 'Success',
      description: 'Success Update Date Contart Finish :',
      style: {
  ...
  return (
    <StyledContactForm>
      ...
      <StyledContactFormContent>
          <StyledContactFormContentItem>
            <StyledContactFormItemTitle>
              <p className='SousTitle'> Contrat Date Information</p>
            ...
            <StyledContactFormContentField>
              ...
              <Form.Item className='form-field'>
                <FloatLabel name="Interview Date">
                  <span className='modallabel'> Date Contart Finish :</span>
                  <DatePicker
                  
                    style={{height:"2rem",marginTop:"0.75rem"}}
                    placeholder={dateemp?.finishDate}
                     onChange={(value) => setNewContartDate(dayjs(value))}
                     value={newContratDate}
                    classNames="ViewInput"
                  />
                </FloatLabel>
              </Form.Item>
