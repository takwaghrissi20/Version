...
const UpdateForm = (props) => {
  ...
  const [newSalary, setnewSalary] = useState(saveIncrease?.newSalary);
  const [newlevel, setnewLevel] = useState(saveIncrease?.newLevel);
  const [newPosition, setnewPosition] = useState(saveIncrease?.newPosition);
  ...
  return (
    <StyledContactForm>
      ...
      <Col xs={24} md={24
          ...
          <AppRowContainer>
            ...
            <Col xs={24} md={12}>
              <Form.Item label='New Salary' name='NewSalary'>
                <Input
                  placeholder={saveIncrease?.newSalary}
                  readOnly
                />
              </Form.Item>
          ...
          <Input
            type='number'
            placeholder={saveIncrease?.newLevel}
            value={newlevel}
          ...
          <Input
            placeholder={saveIncrease?.newPosition}
            readOnly
          />
        </Form.Item>
        </Col>
          ...
          <Input
            placeholder={saveIncrease?.newContractTYpe}
            readOnly
