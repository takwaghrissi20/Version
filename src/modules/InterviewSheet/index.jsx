...
console.log(" setIsNoCheckeddddFinnnaaaaaaaaaaaal",CheckedFinalGotest2)
  ...
  //BOD
  function  OkBod(e) {
    console.log(`checkedBod = ${e.target.checked}`);
    setIsOkCheckedBod(e.target.checked);
  
    if (e.target.checked) {
      setIsNoCheckedBOD(false);
      setIsHoldCheckedBOD(false);
    }
  }

  function NoBod(e) {
    console.log(`NoBod = ${e.target.checked}`);
    setIsNoCheckedBOD(e.target.checked);
   
    if (e.target.checked) {
      setIsOkCheckedBod(false);
      setIsHoldCheckedBOD(false);
    }
  }
  function   HoldBod(e) {
    console.log(`  HoldBod = ${e.target.checked}`);
    setIsHoldCheckedBOD(e.target.checked);
    ...
    >
      ...
      <AppRowContainer>
        <Col xs={24} md={6}>
          ...
          <StyledSecondaryText1>
            Update your Required Position Information.
          </StyledSecondaryText1>
        </Col>
        <Col xs={24} md={18}>
          <StyledShadowWrapper>
      ...
      <AppRowContainer style={{ marginTop: 32, marginBottom: 32 }}>
        <Col xs={24} md={6}>
          ...
          <StyledSecondaryText1>
            Update your Candidate Experience & Education.
          </StyledSecondaryText1>
        </Col>
        <Col xs={24} md={18}>
          <StyledShadowWrapper>
