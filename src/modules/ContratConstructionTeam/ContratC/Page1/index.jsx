...
const ContratCPage1 = ({ fullName, passportNumber, passportSubmitdate, arResidenceAdress, companyType, 
  traveldate, endTravelDate, arDestination, lastId, positionfieledarabe ,salary,arPosition,dailyRate}) => {
      ...
      <div className='ContratPage'>
        ...
        <div dir="rtl">
          ...
          <div className="contrat-page1">
            ...
            يحصل الأجير، مقابل ما يؤديه من مهام، على منحة غربة تقدر ب<span className='infoContrat'>{dailyRate} </span>صافي على كل يوم عمل بموقع الحظيرة
