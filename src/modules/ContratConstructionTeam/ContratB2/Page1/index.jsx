...
const ContratB1Page1 = ({ fullName, passportNumber, passportSubmitdate, arResidenceAdress, companyType, 
  traveldate, endTravelDate, arDestination, lastId, positionfieledarabe ,salary,arPosition,primeProductivity}) => {
      ...
      <div className='ContratPage'>
        ...
        <div dir="rtl">
          ...
          <div className="contrat-page1">
            ...
            <br /><span className='TitleSouligne'>الفصل الرابع: الأجر</span> <br></br>
      
            يحصل الأجير، مقابل ما يؤديه من مهام،على  <span style={{fontWeight:"bold"}}>اجر شهري صافي قدره </span> <span className='infoContrat'>{salary} </span>, ويمنح له منحة الإنتاجية تحسب على أساس<span className='infoContrat'>{primeProductivity} </span> دون المطالبة بامتيازات أخرى.      
