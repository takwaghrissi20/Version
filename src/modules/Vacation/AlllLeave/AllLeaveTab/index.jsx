 ...
 useEffect(() => {
  ...
  const deleteVac = async () => {
    try {
      ...
      if (!response.ok) {
        notification.error({
          message: 'Error Deleting Vacation Record',
          description: 'There was an error while deleting the vacation record. Please try again.',
        });
  ...
  return (
    <div style={{marginBottom:"2rem"}}>
      ...
      dataSource={vacations} size='middle' />
