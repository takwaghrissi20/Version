...
const StatsApprovedVacationCard= ({ countVacationRejected }) => {
      ...
      <StyledFlexWrapper>
        <StyledFlexContainer>
          <StyledIconWrapper
            style={{
              color: "#0A8FDC",
              backgroundColor: countVacationRejected?.color + '22',
            }}
          >
            {/*             
          ...
          <div style={{ marginRight: 8, overflow: 'hidden' }}>
            <Typography.Title level={5}>Rejected</Typography.Title>
            <StyledTitleWrapper>
              <CountUp end={countVacationRejected}></CountUp>
