...
const StatsAllLeaveDirCard = ({ countVacation }) => {
      ...
      <StyledFlexWrapper>
        <StyledFlexContainer>
          <StyledIconWrapper
            style={{
              color: "#0A8FDC",
              backgroundColor: countVacation?.color + '22',
            }}
          >
            {/*             
          ...
          <div style={{ marginRight: 8, overflow: 'hidden' }}>
            <Typography.Title level={5}>All Leaves</Typography.Title>
            <StyledTitleWrapper>
              <CountUp end={countVacation}></CountUp>
...
export default StatsAllLeaveDirCard;
