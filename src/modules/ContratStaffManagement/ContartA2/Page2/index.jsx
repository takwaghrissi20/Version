  ...
  return (
    <div className='page1'>
      <div className='ContratPage'>
        <div className="page">
          <img style={{marginTop:"28px"}} src={image} alt="logo" className="logo" />
        </div>
        ...
        <div dir="rtl">
          ...
          <div className="contrat-page1">
            <p>
            <br></br>* احتساب السفر ذهابا وإيابا يوم عمل <br></br>
            ...
            * احتساب يوم مرض نصف يوم عمل <br></br>
              ...
              *احتساب يوم الإضراب يوم غياب <br></br>
            ...
            <span className='TitleSouligne'>الفصل الثامن: التناوب والتسليم</span>
            <p>
            ...
            <span className='TitleSouligne'>
            الفصل التاسع: في الانتفاع بدورات تكوينية
            </span><br />
            <p>
            ...
            <span className='TitleSouligne'>
            الفصل الحادي عشر: التزام الصحة والسلامة والبيئة
            </span>
            <br />
