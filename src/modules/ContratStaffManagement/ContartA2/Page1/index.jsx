...
const ContratA2Page1 = ({ fullName, passportNumber, passportSubmitdate, arResidenceAdress, companyType,
      ...
      <div className='ContratPage'>
        ...
        <div dir="rtl">
          ...
          <div className="contrat-page1">
            ...
            ابرم هذا العقد بتاريخ<span style={{ fontWeight: "bold", color: "#001f5d", paddingLeft: "5px" }}>{joinDate}</span> ولمدة غير محدودة.
            وعملا <span style={{ fontWeight: "bold" }}>بأحكام الفصل 10 من الاتفاقية المشتركة الإطارية </span> لا يمكن طلب التراجع أو طلب المراجعة أو إعادة النظر في كامل هذا العقد أو جزء منه من طرف أحد المتعاقدين إلا بعد انقضاء مدة 3 أعوام كاملة ابتداء من انطلاقه ثم بعد مدة هده 3 أعوام فالتراجع أو المطالبة بإعادة النظر في هدا العقد لا يمكن القيام بأحد الطريقتين إلا بعد انقضاء عامين مدنيين ودلك عن طريق رسالة مضمونة الوصول مع الإعلام بالبلوغ.

            <br /><span className='TitleSouligne'>الفصل الثالث: مدة التجربة </span><br />
            <p>

              عملا <span style={{ fontWeight: "bold" }}>بأحكام الفصل 10 من الاتفاقية المشتركة الإطارية</span>   يخضع الأجير لفترة تجربة مدتها سنة تنطلق من بداية العقد وقابلة للتجديد مرة واحدة لنفس المدة في صورة سوء نتائج التجربة الأولى. خلال فترة أو فترتي التجربة يمكن إيقاف العمل بهذا العقد ودلك بمجرد إعلام التبليغ .

            </p>


            <span className='TitleSouligne'>الفصل الرابع: مكان العمل </span><br />
            ...
            <br /><span className='TitleSouligne'>لفصل الخامس: الأجر</span>
            ...
            <span className='TitleSouligne'>الفصل السادس: توقيت العمل والعطل</span>
            <p>
             ...
             <br></br> * استراحتين قصيرتين ب 15 دقيقة يوميا في العاشرة صباحا وفي الساعة الثالثة بعد الظهر
