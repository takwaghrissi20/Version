...
const ContratE3S1Page2 = ({duration}) => {
  ...
  return (
    <div className='page1'>
      <div className='ContratPage'>
        <div className="page">
          <img style={{ marginTop: "12rem" }} src={image} alt="logo" className="logo" />
        </div>
    ...
    <span className='TitleSouligne'>  الفصل السابع: في حل النزاعات</span><br></br>
    يصرح الطرفان أنهما قبلا هدا العقد و شروطه و التزما العمل بمقتضاه و في صورة حدوث نزاعات بين الطرفين يكون النظر فيها من طرف محاكم صفاقس 1 <br></br>
 <span style={{fontWeight:"bold",paddingRight:"8px",paddingLeft:"8px"}}>{day} / {today.getDate()} / {month}</span> <br></br>
...
export default ContratE3S1Page2;
