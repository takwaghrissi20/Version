      ...
      <div className='ContratPage'>
        ...
        <div dir="rtl">
          ...
          <div className="contrat-page1">
            ...
            ابرم هذا العقد لمدة
             أشهر/سنة تبتدئ في ??? {joinDate} وتنتهي في ???{finishDate}, ويمكن تجديده لنفس المدة المذكورة و بالشروط الواردة أسفل هذا الفصل إذا احتفظ العامل بعمله إلى حين انقضاء العقد و طبق ما يتطلبه سير عمل الشركة.
...
<span>dailyRate A Ecrire</span>
<span style={{ fontWeight: "bold", color: "#001f5d", paddingLeft: "5px" }}>?????testt</span> 
...
*	 ما يفوق أو يساوي 90يوم عمل بمقر موقع الحظيرة يقابله 21 يوم راحة خالصة الأجر  <br></br>
