...
const TimeSheetOffice = () => {
  ...
  const AddOfficeTimeSheet = () => {
    navigate(`/Hr/Attendances/Add_Office_TimeSheet`, {
  ...
  return (
    <div className='site-statistic-demo-card'>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '1rem' }}>
        <Button onClick={AddOfficeTimeSheet}
          style={{
            marginBottom: "1rem",
            backgroundColor: "#2997ff", color: "white", padding: "10px",
            TextAlign: "center", fontsize: "30px", border: "none"
          }}

        >Add Office Time Sheet</Button>
      </div>
      <AppCard
